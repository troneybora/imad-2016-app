...
var articles = { 
    ...
    'article-three':{
        title:'Article Three | Troney Bora',
...
app.get('/:articleName', function (req,res){
    //articleName==article-new
    //articles[articleName]== {} content object for article new
